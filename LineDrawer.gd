...
func _process(_delta):
	...
	immediate_mesh.surface_add_vertex(start_position_node.global_transform.origin)
	...
	if percentage > 100:
		...
		var target_color = Color.HOT_PINK
		var color = base_color.lerp(target_color, fraction)
